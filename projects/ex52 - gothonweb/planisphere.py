...
"""
Despite your best efforts, you couldn't escape.
Take respite in the fact that you share a grave
with the monsters that tried to enslave you.
""")
...
def load_room(name):
	...
	Make sure that client cant alter globals
	"""
